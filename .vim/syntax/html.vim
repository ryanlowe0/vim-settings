...
if !exists("html_no_rendering")
  ...
  syn region htmlLink start="<a\>\_[^>]*\<href\>[^>]*>[ \t\n]*" end="</a>"me=e-4 contains=@Spell,htmlTag,htmlEndTag,htmlSpecialChar,htmlPreProc,htmlComment,javaScript,@htmlPreproc
...
if version >= 508 || !exists("did_html_syn_inits")
  ...
  HtmlHiLink htmlValue                     Special "String
  ...
  HtmlHiLink htmlPreAttr            Special "String
  HtmlHiLink htmlPreProcAttrName    PreProc
  HtmlHiLink htmlPreProcAttrError   Error
  HtmlHiLink htmlSpecial            PreProc "Special
  HtmlHiLink htmlSpecialChar        PreProc "Special
  HtmlHiLink htmlString             Special "String
